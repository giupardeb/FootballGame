	...
	private void initialize(final Giocatore[] array,final Campionato c) {
		...
		button.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				array[0].setPosizione(1, 1);
				panel_2.add(array[0], gbc_Difensore);
				...
				array[1].setPosizione(3, 1);
				panel_2.add(array[1], gbc_Centrocampista);
				
				array[2].setIcon(new ImageIcon(FinestraFormazione.class.getResource("/images/portiereMio.gif")));
				...
				array[2].setPosizione(5,2);
				panel_2.add(array[2], gbc_Portiere);
				...
				array[3].setPosizione(1,2);
				panel_2.add(array[3], gbc_Difensore1);
				...
				array[4].setPosizione(3, 2);
				panel_2.add(array[4], gbc_Centrocampista1);
				...
				array[5].setPosizione(5,2);
				panel_2.add(array[5], gbc_Attaccante);
				...
				array[6].setPosizione(1, 3);
				panel_2.add(array[6], gbc_Difensore2);
				...
				array[8].setPosizione(5, 3);
				panel_2.add(array[8], gbc_Attaccante1);
				...
				array[9].setPosizione(1, 4);
				panel_2.add(array[9], gbc_Difensore3);
				...
				array[10].setPosizione(3, 4);
				panel_2.add(array[10], gbc_Centrocampista3);
